...
function tanxssp_show(a) {
    ...
    function d() {
        ...
        for (var a, b = k.getElementsByTagName("script"), c = 0, d = b.length; d > c; c++)
            if (a = b[c], "interactive" === a.readyState) return a;
        return null
    }
    var e = {
        lt_pkgs: {
    ...
    if (a[b] !== c) return void (KSLITE.Config.lt_pkgs = KSLITE.mix(e.lt_pkgs, KSLITE.Config.lt_pkgs));
    a[b] = {};
    var f = a.KSLITEonLoad,
		g = a.KSLITEpkgPaths;
    b = a[b];
    var h = a.document,
		...
		j = function (a, b, d, e) {
		    ...
		    return a
		}, k = h.getElementsByTagName("head")[0] || h.documentElement,
		l = 0,
		m = 2,
		n = 4,
		o = /\.css(?:\?|$)/i,
		p = h.createElement("script").readyState ? function (a, b) {
    ...
    j(b, {
        ...
        _init: function () {
            ...
            if (a.KSLITEpkgPaths = {
                ...
                for (l = 0; l < g.length; l++) c(g[l]);
            if (a.KSLITEonLoad = {
                push: function (a) {
					a && b.iF(a) && a(b)
            }
            }, f && b.iA(f))
                for (l = 0; l < f.length; l++) b.iF(f[l]) && f[l](b)
        },
        mix: j,
        log: function (d, e) {
        ...
        _lM: function (a, d) {
            var e, f = b.Env._loadQueue,
				g = a.name,
				h = b.Env.mods;
            if (f[g]) e = f[g], e.c ? (b.log(g + " is already loaded", "warn"), d()) : (b.log(g + " is loading,listen to callback"), e.fns.push(d));
            else {
                ...
                b._gPath(a, function () {
                    h[g] || (h[g] = {
                        ...
                        var a, d, e = f[g];
                        for (b.__m__ && (d = b.__m__, b.add(g, d.fn, d.deps), b.__m__ = null), h[g].status === l && (h[g].status = m), a = 0; a < e.fns.length; a++) e.fns[a]();
                        e.c = !0, e.fns = c
                    }, "gbk", {
                        mod_name: g
                    })
        ...
        declare: function () {
            var a, c, e, f, g, h;
            for (c = 0; c < arguments.length; c++) e = arguments[c], b.iS(e) ? f = e : b.iA(e) ? g = e : b.iF(e) && (h = e);
...
function (a, b) {
    ...
    if (c && b.iA(c))
        for (var d = 0; d < c.length; d++) b.iPO(c[d]) && tanxssp_show(c[d]);
    a.tanx_ssp_onload = {
        push: function (a) {
